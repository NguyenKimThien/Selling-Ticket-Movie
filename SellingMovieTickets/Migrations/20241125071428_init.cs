    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCategoryMappings", x => new { x.MovieId, x.MovieCategoryId });
                    table.ForeignKey(
                        name: "FK_MovieCategoryMappings_MovieCategories_MovieCategoryId",
                        column: x => x.MovieCategoryId,
                        principalTable: "MovieCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCategoryMappings_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CinemaShowTimes_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CinemaShowTimes_RoomId",
                table: "CinemaShowTimes",
                column: "RoomId");
